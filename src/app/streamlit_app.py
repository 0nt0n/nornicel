...
EXAMPLES = [
    "Провести литературный обзор источников техногенного гипса и способов его переработки. Отечественная и/или зарубежная практика.",
    "Обзор <Распределение Аu, Ag и МПГ между медным, никелевым штейном и шлаком (по зарубежным источникам последних лет).>",
